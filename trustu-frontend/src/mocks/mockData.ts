...
export const MOCK_POSTS: PaginatedResponse<Post> = paginated([
  {
    ...
    title: 'PG near main gate with late-night entry?',
    description: 'Does anyone know a good PG near the main gate that allows late-night entry? I have evening lab sessions that go till 10 PM.',
    upvotes: 12,
    replyCount: 3,
    hasUpvoted: false,
  ...
  },
  {
    ...
    userDesignation: 'Student',
    title: 'Swiggy One subscription split — anyone in?',
    description: 'Looking for someone to share a Swiggy One subscription — the annual plan is ₹1,299 and we can split it 4 ways. Anyone interested?',
    upvotes: 8,
    replyCount: 5,
    hasUpvoted: true,
  ...
  },
  {
    ...
    description: 'Reminder: The library will be closed this Saturday for maintenance. Please plan your study sessions accordingly.',
    upvotes: 34,
    replyCount: 2,
    hasUpvoted: false,
  ...
  },
  {
    ...
    title: 'Looking for a flatmate — 2BHK near campus',
    description: 'Hey everyone! I am looking for a flatmate for my 2BHK near campus. Rent is ₹6,500/month including electricity. Vegetarian preferred but not strict.',
    upvotes: 5,
    replyCount: 7,
    hasUpvoted: false,
  ...
  },
  {
    ...
    userName: 'Zara Khan',
    userDesignation: 'Student',
    title: 'Affordable gym recommendations near Jamia Nagar?',
    description: 'Can anyone recommend a good affordable gym near Jamia Nagar? I am looking for something under ₹800/month.',
    upvotes: 19,
    replyCount: 11,
    hasUpvoted: false,
